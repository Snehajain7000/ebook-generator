...
env = jinja2.Environment(loader=jinja2.PackageLoader('coverImageGenerator'))
...
def cover(
    ...
    clr1, clr2, clr3, clr4, clr5, clr6 = colors
    ...
    image = env.get_template(template + '.svg').render(
        ...
        color1=clr1, color2=clr2, color3=clr3, color4=clr4, color5=clr5, color6=clr6,
        font_size=font_size, font_size_author=font_size_author)
    return image
